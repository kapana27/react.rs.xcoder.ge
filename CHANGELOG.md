...
- chore: migration to [Create React App 2.0](https://reactjs.org/blog/2018/10/01/create-react-app-v2.html)
  ...
  - refactor(OverheadModalTable.js): add `react-app-polyfill` for `ie9-11` support
  - refactor(OverheadModalTable.js): migration to `serviceWorker.js`

###### Migrating from CRA 1.x to 2.x:
affected files: 
- `package.json` -> dependencies update  
- `src/OverheadModalTable.js` -> move to `serviceWorker`, add `react-app-polyfill` for `ie9-11` support when needed
