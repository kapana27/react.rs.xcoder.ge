        ...
        <div className="p-grid">
          ...
          <div  style={{minWidth:'350px',maxWidth:'100%', paddingRight:'20px', paddingTop:'12px',flex:'1'}}>
            <div style={{float:'right'}}>
              <Button className="p-button-warning p-button-raised" label="ძებნა" icon="pi pi-search" onClick={props.onFilter} />
              <Button className="p-button-danger p-button-raised" label="გასუფთავება" icon="pi pi-times" style={{marginLeft:'10px'}} onClick={()=>props.onClear()} />
              <Button className="p-button-secondary p-button-raised" label="დახურვა" style={{marginLeft:'20px', float:'right'}} onClick = {props.onClick}/>
            </div>
          </div>
